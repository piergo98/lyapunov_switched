...
#switched_model = create_simple_switched_system()   #the sliding mode system from the original paper, with one unstable mode and one stable mode
switched_model = create_simple_switched_system_MARGSTAB()
